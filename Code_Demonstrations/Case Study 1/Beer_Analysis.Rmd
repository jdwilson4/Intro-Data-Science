...
3) Which beers in this data set are from California?
...
7) How many IPAs are reviewed in this data set? (Note, this includes many different styles including for instance "American Double" and "American Indian Pale Ale.")
