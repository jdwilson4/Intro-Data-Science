...
Each year, fans do their best to predict who will win each matchup in the 68 team tournament. The 68 teams are ranked according to their performance throughout the year and placed, somewhat randomly, in a matchup slot in the tournament on *Selection Sunday*, March 12th this year. As a newly-rising data scientst, your goal is to predict who will win each team matchup in the tournament. We don't have the new schedule for this year, and alas it will be released over Spring break. Instead we will use past tournaments and a collection of team and player variables to analyze and build a model that predicts each matchup in the 2016 tournament. 
...
Along the way, use exploratory data analysis (summaries, plots, etc.) to determine two main things:
...
3) From combining historical data for each team, how would you go about making a model for determining whether or not a team will win its matchup in the NCAA tournament?
